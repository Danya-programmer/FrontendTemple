...
export const Footer = () => {
    ...
    return(
        <footer className={classes.footer}>
            ...
            <div className={classes.copyright}><p style={{color: 'white', fontSize: '16px'}}>© </p><p className={classes.copyrightText}>Храм Рождества Христова и Сергия Радонежского пос.Крутая горка. Все права защищены. 2022-2023 год.</p></div>
        </footer>
    )
}