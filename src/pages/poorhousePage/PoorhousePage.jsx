        ...
        <div style={{background: 'linear-gradient(180deg, #FFFFFF 0%, #ECECEC 99.99%);'}}>
            ...
            <div className={classes.PoorhousePage}>
                ...
                <div className={classes.ImgBack}>
                    ...
                    <div className={classes.ImgTitle}>Богадельня (от слов Бога для, то есть ради Бога) - благотворительное место для содержания нетрудоспособных лиц (престарелых, немощных, инвалидов и пр).</div>
                </div>
