...
export const HistoryPage = () => {
    ...
    return(
     ...
     >В 1995 году в детском садике была выделена комната для совершения богослужений. Так появился Храм в поселке. Первый служил батюшка Ксенофонт. Потом - батюшка Олег (Тыртышный). В дальнейшем он принял монашество с именем Александр. А в 33 года батюшку убили в Колосовке.</div>
            ...
            <img data-aos="slide-up" src={require('../../images/history/history3.jpg')} alt="не работает" className={classes.img3} /> 
                        <div className={classes.text3}> <p className={classes.textWhite} data-aos="slide-up"> Первая служба состоялась в нижнем Храме (с пределом преподобного Сергия Радонежского) в 1997 году на Пасху. </p>
